%Function for inverse quantization
function [SNR_Dq, CR_Dq] = idct_quant(Q_Y, Q_Cb, Q_Cr, I, q)
    %for inverse quantizing for Cb Cr Channels
    ...
    %for inverse quantizing for Y channel
    ...
    %the same matrices as for quantizing
    % Megethos tis eikonas
    [x,y,z] = size(I);
